     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="radio" name="gender" value="male" class="form-control" placeholder="Enter Title">male
                <input type="radio" name="gender" value="female" class="form-control" placeholder="Enter Title">female

    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                ...
                <h2 style="text-align: center;"><b> Delete Category List</b></h2><br>
                @else
                ...
                <div class="pull-right">
                    ...
                    <div class="float-end">
                        ...
                        @else
                        <a href="{{ route('category.index',['trashed' => 'category']) }}" class="btn btn-warning">View Deleted category</a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <table class="table table-bordered">
            ...
            <tbody id="tbody">
                ...
                <tr>
                    ...
                    <td>
                        @if(request()->has('trashed'))
                        <form action="{{ route('category.forcedlt',$value->id) }}" method="GET">
